...
export function WhatsAppFloat() {
  ...
  return (
    <div
      className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-whatsapp text-white shadow-lg shadow-black/25 transition hover:scale-105 print:hidden group"
      style={{ position: "fixed", bottom: "24px", right: "24px", zIndex: 9999 }}
    >
      {isClient && isActive && (
        <div
          className="pointer-events-none drop-shadow-md transition-all duration-300 group-hover:rotate-12"
          style={{
            position: "absolute",
            top: "-12px",
            right: "-2px",
