        ...
        <div>
          ...
          <div className="mt-4 flex items-center gap-3">
            <a
              ...
              className="flex items-center gap-2 rounded-xl bg-white/10 px-3 py-2 text-xs font-bold text-white transition hover:bg-pink-600 hover:text-white"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 rounded-xl bg-white/10 px-3 py-2 text-xs font-bold text-white transition hover:bg-blue-600 hover:text-white"
