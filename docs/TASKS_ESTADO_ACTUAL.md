...
- [ ] **Curso Supervisor — montaje en plataforma (en curso):** ✅ **MDs completados (2026-08-18)**: 18 submódulos (Módulo 1 reordenado con Reglamento 209, Ley 21.659, Derecho penal y DD.HH.) + 6 consolidados, docx de revisión `Curso_Supervisor_Consolidado_v2.docx` — ver sección O. Falta: cliente genera PDFs (NotebookLM) + aporta links de YouTube → montar en la plataforma (patrón bastón/CCTV).
