...
- **Confidencialidad:** manejar con reserva los datos e imágenes que obtiene en el ejercicio de sus funciones, respetando la normativa de protección de datos personales.
...
- Verificación visual de alarmas y novedades reportadas por sensores.
- Registro de eventos en el libro de novedades con horas exactas.
- Comunicación con el personal de terreno por radio o teléfono, con lenguaje claro y breve.
- Aviso oportuno a Carabineros, PDI, Bomberos o servicios de emergencia según el procedimiento de cada instalación.
- Cuidado y resguardo de las grabaciones como material probatorio.
...
## 4. Tarifas y multas de la conexión

- **Renta mensual:** 3 U.F. por cada 100 usuarios o fracción de usuarios conectados.
- **Falsa alarma:** cobro de 0,5 U.F. por cada falsa alarma, ingresados al Fondo Rotativo de Abastecimiento de Carabineros.

## 5. Implicancias para el operador

- La conexión directa con Carabineros permite una respuesta policial más rápida, pero impone altos estándares de confiabilidad del sistema.
- El operador debe verificar las señales antes de confirmar una emergencia, para evitar falsas alarmas que generan costos y desgaste del sistema.
- Ante cualquier activación, se debe seguir el procedimiento definido por la empresa y dejar registro escrito del evento y de las comunicaciones realizadas.

## 6. Relación con la normativa de seguridad privada

- El operador desempeña una labor complementaria y de apoyo a las Fuerzas de Orden y Seguridad.
- Su actuación se enmarca en la normativa de seguridad privada vigente y en las directivas de funcionamiento de la instalación, aprobadas por la autoridad.
- El cumplimiento estricto de los procedimientos protege al operador, a la empresa y a las personas involucradas en cada evento.
