...
const BASE_DIR = 'C:\\Users\\Vickoto\\Downloads\\cctv aprecap';

const FOLDERS = ['modulo 1', 'modulo 2', 'modulo 3'];
...
async function main() {
  ...
  console.log(`Subiendo ${sources.length} PDFs de CCTV a Sanity (${projectId}/${dataset})...`);
