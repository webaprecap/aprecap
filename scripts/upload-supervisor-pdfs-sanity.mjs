...
const MAPPING_FILE = path.resolve(process.cwd(), 'scripts', 'sanity-supervisor-pdf-urls.json');
const ASSETS_URL = `https://${projectId}.api.sanity.io/v2024-03-17/assets/files/${dataset}`;
const BASE_DIR = 'C:\\Users\\Vickoto\\Downloads\\supervisor aprecap';

const FOLDERS = ['modulo 1', 'modulo 2', 'modulo 3', 'modulo 4', 'modulo 5', 'modulo 6'];
...
async function main() {
  ...
  console.log(`Subiendo ${sources.length} PDFs de Supervisor de Seguridad a Sanity (${projectId}/${dataset})...`);
